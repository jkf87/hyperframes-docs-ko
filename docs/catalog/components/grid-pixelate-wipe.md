...
> 화면이 격자 형태의 사각형으로 분해되며 시차를 두고 페이드 아웃되는 전환 효과 — 장면 간 전환에 사용
...
`compositions/components/grid-pixelate-wipe.html`을 열고 그 내용을 컴포지션에 붙여넣으세요. 자세한 안내는 파일 상단의 주석 헤더를 참조하세요.
